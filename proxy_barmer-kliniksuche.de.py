...
excel_file = openpyxl.load_workbook('2022.xlsx')
...
logging.basicConfig(
    ...
    filename=f'debug_barmer-kliniksuche.de.log'
)
...
all_finish_time = time.time() - all_start_time

logger.info(f'Work is done! Time spent: {all_finish_time}\n')
